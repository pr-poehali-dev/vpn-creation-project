	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-neon': {
					'0%, 100%': {
						textShadow: '0 0 5px rgba(255, 0, 128, 0.8), 0 0 10px rgba(255, 0, 128, 0.6), 0 0 15px rgba(255, 0, 128, 0.4)'
					},
					'50%': {
						textShadow: '0 0 10px rgba(255, 0, 128, 1), 0 0 20px rgba(255, 0, 128, 0.8), 0 0 30px rgba(255, 0, 128, 0.6)'
					}
				}
			},
			animation: {
